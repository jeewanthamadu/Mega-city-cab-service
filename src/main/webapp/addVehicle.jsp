...
<head>
    ...
    <style>
        ...
        .form-container {
            ...
            padding: 20px;
            width: 100%;
            max-width: 1200px;  /* Increased to match table width */
        }
        ...
        .submit-button {
            ...
            width: 100%;
            font-size: 16px;
            grid-column: span 3;  /* Make the submit button span across all columns */
        }
...
<body>
<div class="container">
    <!-- Form Container for Adding Vehicle -->
    ...
    <!-- Table Container for Viewing Vehicles -->
    <div class="table-container">
        ...
        <table id="vehicleTable">
            ...
            <tbody>
            &lt;%&ndash; Loop through vehicle list and display records dynamically &ndash;%&gt;
